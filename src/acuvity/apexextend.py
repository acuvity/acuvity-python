...
setattr(Apex, "police", police)
setattr(Apex, "police_async", police_async)
setattr(Apex, "__build_police_request", __build_police_request)
setattr(Apex, "__build_scan_request", __build_scan_request)
