...
class Detector(ElementalModel):
    """
    Represent a detector an analyzer can use.

    Attributes:
        description: The description of the detection.
        group: The group the detection belongs to.
        label: The label returned by the model.
        name: The name of the detection.
        positional: Tell if the detection is positional.
    """
    ...
    positional: Optional[bool] = Field(
        None,
        alias="positional",
