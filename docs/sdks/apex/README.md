...
<!-- UsageSnippet language="python" operationID="get-all-Analyzers" method="get" path="/_acuvity/analyzers" -->
```python
import acuvity
...
<!-- UsageSnippet language="python" operationID="create-ScanRequest-as-ScanResponse" method="post" path="/_acuvity/scan" -->
```python
import acuvity
from acuvity import Acuvity
import os
